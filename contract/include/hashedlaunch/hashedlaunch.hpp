...
public:
    ...
    [[eosio::action]]
    void create(name issuer, asset maximum_supply, string token_name, string metadata_uri);
    ...
    [[eosio::action]]
    void setmeta(name issuer, symbol_code symcode, string token_name, string metadata_uri);
